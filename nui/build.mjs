...
const map = { onduty: 'flrp_onduty', reports: 'flrp_reports', gunstores: 'flrp_gunstores', spawn: 'flrp_spawn', jail: 'flrp_jail', greenzone: 'flrp_greenzone', messages: 'flrp_messages' };

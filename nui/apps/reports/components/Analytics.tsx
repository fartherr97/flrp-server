...
export function Analytics() {
  ...
  const Stat = ({ label, value, sub, accent }: { label: string; value: string; sub: string; accent?: string }) => (
    <Panel className="relative overflow-hidden border-2 border-border p-3"><span className={`absolute inset-y-0 left-0 w-0.5 ${accent || 'bg-primary'}`} />
  ...
  return (
    <div className="space-y-4 py-1">
      ...
      <Panel className="border-2 border-border p-3.5">

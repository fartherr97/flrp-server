...
export interface Nearby { id: number; name: string; distance: number }
export interface Report {
  ...
  messages: Msg[]; canReturn?: boolean; nearby?: Nearby[] | null;
}
...
export interface State {
  ...
  logo: string; serverName: string; nearbyDistance?: number;
